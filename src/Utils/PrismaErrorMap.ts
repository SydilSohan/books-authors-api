...
export const prismaErrorMap: { [key: string]: string } = {
  ...
  P2002: "Unique constraint failed on the specified field.",
  ...
  P2011: "Null constraint violation on the specified field.",
  ...
  P6008: "The engine failed to start.",
  P6009: "The global response size limit of Accelerate has been exceeded.",
  P6010: "Your accelerate project is disabled.",
  P6100: "An unexpected server error occurred.",
  P6101: "The datasource is not reachable by Prisma Pulse.",
